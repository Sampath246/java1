...
class LList<T> implements ListInterface<T> {
    ...
    */
    ...
    public void cycle() {
        ...
        // CODE TO BE COMPLETED 
    	Node first_ref=firstNode,temp_trav=firstNode;
    	//if list contains one element then there is no need for cycling
    	if(firstNode.next==null)
    	{
    		return;
    	}
    	//traversing the list to get the last link!
    	while(temp_trav.next!=null)
    	{
    		temp_trav=temp_trav.next;
    	}
    	temp_trav.next=first_ref; 
